1. Data was scraped from the GitHub API by filtering users in Banglore with over 100 followers and fetching their most recent repositories using the requests library of Python.
